...
@class CS6021_TableSourceControlUnit;
@class ViewCtrl_Keyboard;
@class ViewCtrl_Memory;
@class CS6021_TableSourceMemory;
@class CS6021_TableSourceKeyboard;
@class CS6021_UISliderCustom;
@class ViewCtrl_ControlUnit;
...
@interface CS6021_TableSourceControlUnit : NSObject<UIScrollViewDelegate, UIScrollViewDelegate, UIScrollViewDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface ViewCtrl_Keyboard : UIViewController {
	...
	@property (nonatomic, assign) UIBarButtonItem * btn_keyboard_add;
	@property (nonatomic, assign) UITableView * tblVw_Keyboard;
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
	-(bool) xamarinSetGCHandle: (GCHandle) gchandle flags: (enum XamarinGCHandleFlags) flags;
	-(enum XamarinGCHandleFlags) xamarinGetFlags;
	-(void) xamarinSetFlags: (enum XamarinGCHandleFlags) flags;
	-(UIBarButtonItem *) btn_keyboard_add;
	-(void) setBtn_keyboard_add:(UIBarButtonItem *)p0;
	-(UITableView *) tblVw_Keyboard;
	-(void) setTblVw_Keyboard:(UITableView *)p0;
	-(void) viewDidLoad;
...
@interface ViewCtrl_Memory : UIViewController {
	...
	@property (nonatomic, assign) UIBarButtonItem * btn_memory_add;
	...
	@property (nonatomic, assign) UITableView * tblVw_Memory;
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
	-(bool) xamarinSetGCHandle: (GCHandle) gchandle flags: (enum XamarinGCHandleFlags) flags;
	-(enum XamarinGCHandleFlags) xamarinGetFlags;
	-(void) xamarinSetFlags: (enum XamarinGCHandleFlags) flags;
	-(UIBarButtonItem *) btn_memory_add;
	-(void) setBtn_memory_add:(UIBarButtonItem *)p0;
	...
	-(UITableView *) tblVw_Memory;
	-(void) setTblVw_Memory:(UITableView *)p0;
	-(void) viewDidLoad;
	-(void) didReceiveMemoryWarning;
...
@interface CS6021_TableSourceMemory : NSObject<UIScrollViewDelegate, UIScrollViewDelegate, UIScrollViewDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface CS6021_TableSourceKeyboard : NSObject<UIScrollViewDelegate, UIScrollViewDelegate, UIScrollViewDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface ViewCtrl_ControlUnit : UIViewController {
}
	@property (nonatomic, assign) UIBarButtonItem * btn_controlUnit_add;
	...
	@property (nonatomic, assign) UITableView * tablVw_ControlUnit;
	...
	-(enum XamarinGCHandleFlags) xamarinGetFlags;
	-(void) xamarinSetFlags: (enum XamarinGCHandleFlags) flags;
	-(UIBarButtonItem *) btn_controlUnit_add;
	-(void) setBtn_controlUnit_add:(UIBarButtonItem *)p0;
	...
	-(UITableView *) tablVw_ControlUnit;
	-(void) setTablVw_ControlUnit:(UITableView *)p0;
