...
namespace CS6021
{
	[Register ("ViewCtrl_ControlUnit")]
	partial class ViewCtrl_ControlUnit
	{
		[Outlet]
		UIKit.UIBarButtonItem btn_controlUnit_add { get; set; }
		...
		[Outlet]
		UIKit.UITableView tablVw_ControlUnit { get; set; }
		...
		[Action ("knob_slided:")]
		partial void knob_slided (UIKit.UISwipeGestureRecognizer sender);
		...
		{
			if (tablVw_ControlUnit != null) {
				tablVw_ControlUnit.Dispose ();
				tablVw_ControlUnit = null;
			}

			if (btn_controlUnit_add != null) {
				btn_controlUnit_add.Dispose ();
				btn_controlUnit_add = null;
			}
