...
namespace CS6021
{
	public partial class ViewCtrl_CentralUnit : UIViewController
	{
        ...
        public ViewCtrl_CentralUnit (IntPtr handle) : base (handle)
		{
		}
        ...
        public override void ViewDidLoad()
        {
            ...
            {
                protocol = Locomotive.e_DecoderType.MFX,
                address = 6,
                speed = 0,
        ...
        partial void sld_speed_touch_down(UISlider sender)
        {
            //centralUnitInstance.SetActiveLocomotivesSpeed((int)sld_speed.Value);
            //UpdateLocomotive(true);
        }
        ...
        /*private async void ShowDialogIpConnectionAsync()
        {

            string result = await App.Current.MainPage.DisplayPromptAsync("Please enter IP-Adress or Hostname of your Central Station");
